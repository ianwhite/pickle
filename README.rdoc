...
(you'd better install cucumber)
  ...
  script/generate pickle [page] [email]

Now have a look at <tt>features/step_definitions/pickle_steps.rb</tt>

If you want page steps and email steps then just add 'page' and/or 'email'.  The steps will be
written to <tt>features/step_definitions/pickle_page_steps.rb</tt> and
<tt>features/step_definitions/pickle_email_steps.rb</tt> respectively.
