...
This code does not work, it's a work in progress.

Use the master branch, or gem releases.
...
To run the specs and features against rails 2.3.9 do:

  bundle
  # if you get an error here run 'bundle update rack'

  bundle exec rake spec:all
  bundle exec rake cucumber

To run the specs against rails 3

  PICKLE_RAILS3=true bundle
  # if you get an error here run 'PICKLE_RAILS3=true bundle update rack'
  
  PICKLE_RAILS3=true bundle exec rake spec:all
